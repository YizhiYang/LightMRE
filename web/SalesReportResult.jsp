...
<html>
    ...
    <body>
        ...
        <div class="container">  
            <form id="contact" action="SalesReport.jsp" method="post">
                <h3>Amount</h3>
                
                <fieldset>
                    <input name="lastName" value ="$${amount}" type="text" tabindex="1" readonly="readonly" required autofocus>
                </fieldset>
                
                <fieldset>
                    <button name="submit" type="submit" id="contact-submit" data-submit="...Sending">Obtain Another One</button>
                </fieldset>
            </form>
