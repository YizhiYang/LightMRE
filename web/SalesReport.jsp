...
<html>
    ...
    <body>
        ...
        <div class="container">  
            <form id="contact" action="http://localhost:8080/LightMRE/SalesReport" method="post">
                <h3>Search for Sales Report</h3>
                <fieldset>
                    <input name="month" placeholder="Month (Number Only)" type="text" tabindex="1" required autofocus>
                </fieldset>
                <fieldset>
                    <input name="year" placeholder="Year (Number Only)" type="text" tabindex="2" required>
                </fieldset>

                <fieldset>
                    <button name="submit" type="submit" id="contact-submit" data-submit="...Sending">Obtain</button>
                </fieldset>
            </form>
        </div>
