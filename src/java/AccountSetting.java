...
public class AccountSetting extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AccountSetting at " + request.getSession().getAttribute("userName") + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String username = (String) request.getSession().getAttribute("userName");
             ResultSet rs = DBConnect.getAccountForEdit(request.getParameter(username));
